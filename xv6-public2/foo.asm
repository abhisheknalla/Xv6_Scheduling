...
int main (int argc,char *argv[])
{
   ...
   e:	53                   	push   %ebx
   f:	51                   	push   %ecx
  10:	be 50 00 00 00       	mov    $0x50,%esi
...
int main (int argc,char *argv[])
{
  ...
  1e:	74 2d                	je     4d <main+0x4d>
	...
	for(k=0;k<n;k++) {
		id = fork();
  20:	e8 c5 02 00 00       	call   2ea <fork>
  ...
  27:	89 c3                	mov    %eax,%ebx
		if(id < 0) printf(1,"%d failed in fork!\n",getpid());
  29:	78 34                	js     5f <main+0x5f>
		else if (id > 0) {
  2b:	74 4a                	je     77 <main+0x77>
			printf(1,"Parent %d creating child", getpid(), id);
  2d:	e8 40 03 00 00       	call   372 <getpid>
  32:	53                   	push   %ebx
  33:	50                   	push   %eax
  34:	68 70 07 00 00       	push   $0x770
  39:	6a 01                	push   $0x1
  3b:	e8 10 04 00 00       	call   450 <printf>
			wait();
  40:	e8 b5 02 00 00       	call   2fa <wait>
  45:	83 c4 10             	add    $0x10,%esp
	...
	exit();
  48:	e8 a5 02 00 00       	call   2f2 <exit>
  ...
  50:	ff 70 04             	pushl  0x4(%eax)
  53:	e8 28 02 00 00       	call   280 <atoi>
  58:	83 c4 10             	add    $0x10,%esp
  5b:	89 c6                	mov    %eax,%esi
  5d:	eb c1                	jmp    20 <main+0x20>
	...
	for(k=0;k<n;k++) {
		id = fork();
		if(id < 0) printf(1,"%d failed in fork!\n",getpid());
  5f:	e8 0e 03 00 00       	call   372 <getpid>
  64:	51                   	push   %ecx
  65:	50                   	push   %eax
  66:	68 89 07 00 00       	push   $0x789
  6b:	6a 01                	push   $0x1
  6d:	e8 de 03 00 00       	call   450 <printf>
  72:	83 c4 10             	add    $0x10,%esp
  75:	eb d1                	jmp    48 <main+0x48>
		else if (id > 0) {
			printf(1,"Parent %d creating child", getpid(), id);
			wait();
		}
  ...
  77:	e8 f6 02 00 00       	call   372 <getpid>
  7c:	52                   	push   %edx
  7d:	50                   	push   %eax
  7e:	68 9d 07 00 00       	push   $0x79d
  83:	6a 01                	push   $0x1
  85:	e8 c6 03 00 00       	call   450 <printf>
			set_priority(priority);
  8a:	89 34 24             	mov    %esi,(%esp)
  8d:	e8 10 03 00 00       	call   3a2 <set_priority>
  ...
  94:	83 c4 10             	add    $0x10,%esp
			for( z =0; z< 8000000.0; z +=d) {
  97:	dd 05 b0 07 00 00    	fldl   0x7b0
  9d:	dc c1                	fadd   %st,%st(1)
  9f:	d9 05 b8 07 00 00    	flds   0x7b8
  a5:	df ea                	fucomip %st(2),%st
  a7:	77 f4                	ja     9d <main+0x9d>
  a9:	dd d8                	fstp   %st(0)
  ab:	dd d8                	fstp   %st(0)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ef:	f7 f6                	div    %esi
 3f1:	0f b6 92 c4 07 00 00 	movzbl 0x7c4(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 568:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 56b:	b8 bc 07 00 00       	mov    $0x7bc,%eax
