...
int main (int argc,char *argv[])
{
  ...
  13:	8b 71 04             	mov    0x4(%ecx),%esi
	...
	int status, a, b;	
	pid = fork();
  16:	e8 9f 02 00 00       	call   2ba <fork>
	if (pid == 0)
  1b:	85 c0                	test   %eax,%eax
  1d:	75 28                	jne    47 <main+0x47>
  	{	
  		exec(argv[1], &argv[1]);
  1f:	8d 46 04             	lea    0x4(%esi),%eax
  22:	53                   	push   %ebx
  23:	53                   	push   %ebx
  24:	50                   	push   %eax
  25:	ff 76 04             	pushl  0x4(%esi)
  28:	e8 cd 02 00 00       	call   2fa <exec>
    	printf(1, "exec %s failed\n", argv[1]);
  2d:	83 c4 0c             	add    $0xc,%esp
  30:	ff 76 04             	pushl  0x4(%esi)
  33:	68 40 07 00 00       	push   $0x740
  38:	6a 01                	push   $0x1
  ...
  3f:	83 c4 10             	add    $0x10,%esp
 	...
 	exit();
  42:	e8 7b 02 00 00       	call   2c2 <exit>
  ...
  4e:	50                   	push   %eax
  4f:	8d 45 e0             	lea    -0x20(%ebp),%eax
  52:	50                   	push   %eax
  53:	e8 0a 03 00 00       	call   362 <waitx>
 	    printf(1, "Wait Time = %d\n Run Time = %d with Status %d Child id %d\n", a, b, status,pid); 
  58:	5a                   	pop    %edx
  59:	59                   	pop    %ecx
  5a:	53                   	push   %ebx
  5b:	50                   	push   %eax
  5c:	ff 75 e4             	pushl  -0x1c(%ebp)
  5f:	ff 75 e0             	pushl  -0x20(%ebp)
  62:	68 50 07 00 00       	push   $0x750
  67:	6a 01                	push   $0x1
  69:	e8 b2 03 00 00       	call   420 <printf>
  6e:	83 c4 20             	add    $0x20,%esp
  71:	eb cf                	jmp    42 <main+0x42>
  73:	66 90                	xchg   %ax,%ax
  75:	66 90                	xchg   %ax,%ax
  77:	66 90                	xchg   %ax,%ax
  79:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3bf:	f7 f6                	div    %esi
 3c1:	0f b6 92 94 07 00 00 	movzbl 0x794(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 538:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 53b:	b8 8c 07 00 00       	mov    $0x78c,%eax
...
free(void *ap)
{
 ...
 617:	89 08                	mov    %ecx,(%eax)
  freep = p;
 619:	a3 34 0a 00 00       	mov    %eax,0xa34
}
 61e:	5b                   	pop    %ebx
 61f:	5e                   	pop    %esi
 620:	5f                   	pop    %edi
 ...
 63a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 63d:	a3 34 0a 00 00       	mov    %eax,0xa34
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 6af:	76 3f                	jbe    6f0 <malloc+0xa0>
    ...
    if(p == freep)
 6b1:	39 05 34 0a 00 00    	cmp    %eax,0xa34
 ...
 6d6:	e8 e5 fe ff ff       	call   5c0 <free>
  return freep;
 6db:	8b 15 34 0a 00 00    	mov    0xa34,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 6fc:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 6ff:	89 15 34 0a 00 00    	mov    %edx,0xa34
      return (void*)(p + 1);
 ...
 714:	eb e9                	jmp    6ff <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 716:	c7 05 34 0a 00 00 38 	movl   $0xa38,0xa34
 71d:	0a 00 00 
 720:	c7 05 38 0a 00 00 38 	movl   $0xa38,0xa38
 727:	0a 00 00 
    base.s.size = 0;
 72a:	b8 38 0a 00 00       	mov    $0xa38,%eax
